...
export class SiteSettingsComponent {
  ...
  readonly form = this.fb.nonNullable.group({
    ...
    iconColor: ['#ffffff', [Validators.required, Validators.pattern(HEX_COLOR_PATTERN)]],
    backgroundImageUrl: [''],
    centerLogoUrl: [''],
    address: [''],
    phone: [''],
    ...
    managerWhatsApp2: ['', [Validators.maxLength(30)]],
    managerWhatsApp3: ['', [Validators.maxLength(30)]],
    isCashEnabled: [true],
    isVisaEnabled: [false],
    visaFawryUrl: [''],
  ...
  save(): void {
    ...
    this.settingsService
      .update({
        ...
        estimatedDeliveryMinMinutes: raw.estimatedDeliveryMinMinutes,
        estimatedDeliveryMaxMinutes: raw.estimatedDeliveryMaxMinutes,
        managerWhatsApp1: raw.managerWhatsApp1 || null,
        managerWhatsApp2: raw.managerWhatsApp2 || null,
        managerWhatsApp3: raw.managerWhatsApp3 || null,
