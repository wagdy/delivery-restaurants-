...
public class SubCategoriesController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<ActionResult<SubCategoryResponse>> Create(SubCategoryRequest request)
    {
    ...
    [Authorize(Policy = "Module.MenuItems")]
    [HttpPut("reorder")]
    public async Task<IActionResult> Reorder(ReorderSubCategoriesRequest request)
    {
    ...
    [Authorize(Policy = "Module.MenuItems")]
    [HttpPut("{id:int}")]
    public async Task<ActionResult<SubCategoryResponse>> Update(int id, SubCategoryRequest request)
    {
